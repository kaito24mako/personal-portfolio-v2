    ...
    <>
      ...
      >
        <svg
          ...
          className="feather feather-github w-5 h-5 sm:w-7 sm:h-7"
        >
      ...
      >
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="feather feather-facebook w-5 h-5 sm:w-7 sm:h-7"
        >
      ...
      >
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="feather feather-instagram w-5 h-5 sm:w-7 sm:h-7"
        >
