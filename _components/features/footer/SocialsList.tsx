    ...
    <>
      ...
      >
        <svg
          ...
          className="feather feather-github w-5 h-5 sm:w-6 sm:h-6"
        >
      ...
      >
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="feather feather-facebook w-5 h-5 sm:w-6 sm:h-6"
        >
      ...
      >
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="feather feather-instagram w-5 h-5 sm:w-6 sm:h-6"
        >
